...
public class App extends Application {
    public static final String CHANNEL_REMINDER_ID = "com.vibal.utilities.App.CHANNEL_REMINDER";
    public static final String CHANNEL_PERIODIC_ID = "com.vibal.utilities.App.CHANNEL_PERIODIC";
